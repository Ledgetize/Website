    ...
    <div>
      <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
        <div class="mx-auto mb-8 max-w-screen-sm lg:mb-16">
          ...
          <p cas="font-light text-gray-500 sm:text-xl dark:text-gray-400">
            Explore the whole collection of open-source web components and
            elements built with the utility classes from Tailwind
          </p>
        </div>
        <div class="grid gap-8 lg:gap-16 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3">
          <div class="text-center text-gray-500 dark:text-gray-400">
            <img
              class="mx-auto mb-4 w-36 h-36 rounded-full"
              src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
              alt="Andrés Pérez Avatar"
            />
            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Andrés Pérez</a>
            </h3>
            <p>CEO/Co-founder</p>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
            <img
              ...
              alt="Alvaro Farreny Avatar"
            />
            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Álvaro Farreny</a>
            </h3>
            <p>CTO/Co-founder</p>
            <ul class="flex justify-center mt-4 space-x-4">
              <li>
          ...
          <div class="text-center text-gray-500 dark:text-gray-400">
            <img
              ...
              alt="Iñigo Estévez Avatar"
            />
            <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
              <a href="#">Iñigo Estévez</a>
            </h3>
            <p>SEO & Marketing</p>
            <ul class="flex justify-center mt-4 space-x-4">
              <li>
